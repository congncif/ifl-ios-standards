...
> **Release status (2026-07-14):** this payload is the unpublished `1.0.0-rc.5` working candidate.
...
`1.0.0-rc.5` working candidate; the latest published release and public pin remain
