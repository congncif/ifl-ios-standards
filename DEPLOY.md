...
> **Current status (2026-07-14):** this branch contains the unpublished `1.0.0-rc.6` working
...
The current working candidate must not use these commands because no `v1.0.0-rc.6` tag or release
